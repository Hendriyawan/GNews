...
public class FragmentBeritaTerbaru extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
		View v = inflater.inflate(R.layout.layout_berita_terbaru, container, false);
		...
		Berita.load(getActivity(), mRecyclerView, NewsApi.GET_TOP_HEADLINES);
