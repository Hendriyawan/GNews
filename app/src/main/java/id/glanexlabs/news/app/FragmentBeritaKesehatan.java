...
public class FragmentBeritaKesehatan extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
		View v = inflater.inflate(R.layout.layout_berita_kesehatan, container, false);
		...
		Berita.load(getActivity(), mRecyclerView, NewsApi.GET_CATEGORY_HEALTH);
