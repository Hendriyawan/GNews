...
public class FragmentBeritaBisnis extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
		View v = inflater.inflate(R.layout.layout_berita_bisnis, container, false);
		...
		Berita.load(getActivity(), mRecyclerView, NewsApi.GET_CATEGORY_BUSINESS);
		return v;
