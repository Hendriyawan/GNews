...
public class FragmentBeritaTeknologi extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
		View v = inflater.inflate(R.layout.layout_berita_teknologi, container, false);
		...
		Berita.load(getActivity(), mRecyclerView, NewsApi.GET_CATEGORY_TECHNOLOGY);
